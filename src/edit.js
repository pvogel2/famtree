...
export default function Edit({ attributes, setAttributes, clientId  }) {
    const { align, founder, founderFAB, textColor, backgroundColor, foregroundColor, highlightColor, selectionColor, treeLayout, roundedBending } = attributes;
    ...
    return (
      <div { ...useBlockProps() }>
        <InspectorControls>
          ...
          <PanelBody
            title={ __('Layout Settings', 'famtree') }
            initialOpen={ false }
          >
            <SelectControl
